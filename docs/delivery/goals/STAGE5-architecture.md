...
| S5-005 | yes | UX flows + all interface/failure/loading/empty/permission/accessibility/recovery states defined | UX review | 12 flows + full state matrix + component specs + canonical rules; Figma frames | docs/design/, Figma file SYQn5hFY8YVQKm3c6rw0eJ | PASS |
