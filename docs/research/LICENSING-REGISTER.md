...
| **NIV** (Biblica/Zondervan) | Copyrighted — licence required. **API.Bible carries NIV but EXCLUDES it from commercial use (verified 2026-07-25)** → the only commercial route is Biblica's Standard Publishing License (direct, case-by-case) | ❌ | ✅ | ⚠️ non-commercial only via API.Bible; commercial = direct Biblica | Yes | OBSERVED / High | biblica.com/permissions (Wayback 2026-05-07), api.bible verification pass 2026-07-25 |
...
| **The Message (MSG)** | Copyrighted (NavPress; permissions administered by **Tyndale**) — gratis 500 verses print/eBook only; licence required beyond | ❌ | ✅ | ✅ (API.Bible, DOCUMENTED) | Yes | OBSERVED / High | navpress.com/permissions (2026-07-25) |
| **Amplified (AMP, 2015)** | Copyrighted (Lockman) — gratis **1,000 verses any form**, but **≤1,000 verses in an electronic retrieval system** → full-text app needs written permission | ❌ | ✅ | ✅ (API.Bible "Amplified", edition unconfirmed) | **Yes** (apps: full notice + clickable lockman.org link; slides: "AMP") | OBSERVED / High | lockman.org permissions (2026-07-25) |
| **Amplified Classic (AMPC, 1987)** | Copyrighted (Lockman) — same policy as AMP; the licensing difference is essentially the notice/abbreviation ("AMPC"). Lockman demonstrably licenses software vendors (e-Sword, Olive Tree, Accordance, Logos…) | ❌ | ✅ | ⚠️ API.Bible availability UNKNOWN (edition unspecified in catalog); direct Lockman form otherwise | **Yes** ("AMPC") | OBSERVED / High | lockman.org permissions + /digital (2026-07-25) |
| **TPT** (The Passion Translation) | Copyrighted (**Passion & Fire Ministries**; permissions via **BroadStreet Publishing**) — gratis 500 verses/≤20%; no aggregator route found (absent from API.Bible mentions); direct licence only. Presentation-software precedent exists (Proclaim, EasyWorship, BigScreen, ProPresenter logoed on tpt.com). ⚠️ **Stability/reputational risk**: removed from Bible Gateway 2022; text in "expanded review" (full Bible est. **2029**); 2026 plagiarism-allegation reporting. Contradiction retained: YouVersion page OBSERVED live 2026-07-25 vs one report read as removal | ❌ | ✅ | ❌ (no aggregator) | Yes ("TPT") | OBSERVED / High | thepassiontranslation.com/permissions + /church-presentation-software (2026-07-25) |
