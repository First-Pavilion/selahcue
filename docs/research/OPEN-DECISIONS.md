...
| OD-04 | Product positioning/pricing model | Free/OSS · freemium · subscription · perpetual+support | Defer to Stage 3; discovery suggests a **free tier + fair/regional paid tiers** lane (vs ProPresenter price, PewBeam Global-South). Not needed to start building. **Licensing *model* facet DECIDED 2026-08-09 → DEC-004: account-identity spine + account-bound device instances + activation-cached offline entitlement (hybrid); tiers/price points still open.** | User |
